...
namespace LordsAIO
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Chat.Print("Lords AIO Version 3");
            Helper = new Helper();

            Menu = new Menu("LordsAIO", "LordsAIO_" + ObjectManager.Player.ChampionName, true);
            ...
            Chat.Print("Lords AIO bu LordZEDith loaded! (If something is not working please report it)");
        }
    }
}