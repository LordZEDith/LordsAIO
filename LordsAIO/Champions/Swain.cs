...
namespace LordsAIO.Champions
{
    internal class Swain : Champion
    {
        ...
        public int DelayTick_Roff;
        public int DelayTick_Ron;
        public Spell E;
        public Spell Q;
        public Spell R;
        public Spell W;
        ...
        private void Cast_R_off()
        {
            ...
            if (
                MinionManager.GetMinions(ObjectManager.Player.Position, R.Range, MinionTypes.All, MinionTeam.NotAlly)
                    .Count + Utility.CountEnemiesInRange((int) R.Range + 100) == 0)
            {
                R.Cast();
            }
        }
        ...
        private void Cast_R_on()
        {
            ...
            if (
                MinionManager.GetMinions(ObjectManager.Player.Position, R.Range, MinionTypes.All, MinionTeam.NotAlly)
                    .Count >= 1 && ManaManagerAllowCast(R))
            {
                R.Cast();
            }
        }
