    ...
    internal class Jax : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            Program.Menu.SubMenu("TeamFight")
                .AddItem(
                    new MenuItem("useQ_TeamFight", "Use Q").SetValue(
                        new StringList(new[] { "Not", "Out of Range", "Always" }, 1)));
            ...
            Program.Menu.SubMenu("TeamFight")
                .AddItem(new MenuItem("useR_TeamFight", "Use R if Enemys").SetValue(new Slider(2, 5, 0)));
            ...
            Program.Menu.SubMenu("Harass")
                .AddItem(
                    new MenuItem("useQ_Harass", "Use Q").SetValue(
                        new StringList(new[] { "Not", "Out of Range", "Always" })));
        ...
        private void CastE()
        {
            ...
            switch (Program.Orbwalker.ActiveMode)
            {
                ...
                case Orbwalking.OrbwalkingMode.LaneClear:
                    ...
                    if (
                        allMinions.Count(
                            minion => minion.IsValidTarget(Orbwalking.GetRealAutoAttackRange(ObjectManager.Player))) >=
                        1)
                    {
                        E.Cast();
                    }
