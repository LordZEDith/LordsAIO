    ...
    internal class Khazix : Champion
    {
        ...
        private void CastEMinion()
        {
            ...
            var minions = MinionManager.GetMinions(
                ObjectManager.Player.Position, E.Range + (E.Width / 2), MinionTypes.All, MinionTeam.NotAlly);
            if (minions.Count == 0)
            {
                return;
            }
        ...
        private void CastWMinion()
        {
            ...
            var allMinions = MinionManager.GetMinions(
                ObjectManager.Player.Position, W.Range + 50, MinionTypes.All, MinionTeam.NotAlly);
