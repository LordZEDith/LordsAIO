    ...
    internal class Lucian : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            Program.Menu.SubMenu("TeamFight")
                .AddItem(
                    new MenuItem("useE_TeamFight_Range", "E Target in Range").SetValue(new Slider(1100, 2000, 500)));
            Program.Menu.SubMenu("TeamFight").AddItem(new MenuItem("useR_TeamFight", "Use R").SetValue(false));
            Program.Menu.SubMenu("TeamFight")
                .AddItem(new MenuItem("useR_TeamFight_2", "Use R if rest on CD").SetValue(true));
            ...
            Program.Menu.SubMenu("LaneClear")
                .AddItem(
                    new MenuItem("useE_LaneClear_Range", "E Minion in Range").SetValue(new Slider(1100, 2000, 500)));
            ...
            switch (Program.Orbwalker.ActiveMode)
            {
                case Orbwalking.OrbwalkingMode.Combo:
                    ...
                    if (Program.Menu.Item("useR_TeamFight").GetValue<bool>() ||
                        Program.Menu.Item("useR_TeamFight_2").GetValue<bool>())
                    {
                        CastREnemy();
                    }
                    break;
        ...
        {
            if ((Program.Menu.Item("useR_TeamFight_2").GetValue<bool>() && (Q.IsReady() || W.IsReady() || E.IsReady())) ||
