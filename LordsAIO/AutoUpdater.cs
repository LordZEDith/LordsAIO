...
//		{
//			Chat.Print ("LordsAIO by LordZedith loading ...");
...
//			{
//				Chat.Print("LordsAIO is Updating ...");
//				Chat.Print("-- Using trellis Updater --");
//				if (myUpdater.Update())
//				{
//					Chat.Print("LordsAIO is Updateed, Reload Please.");
//					Properties.Settings.Default.Reset();
//				}
//			}
//			else
//				Chat.Print(string.Format("LordsAIO ( Version: {0} ) loaded!", Localversion));
//		}
//	}
...
//			_wc.Headers["User-Agent"] = "LordsAIO Client";
...
//			catch(Exception ex)
//			{
//				Chat.Print("LordsAIO-Updater Error: " + ex.Message);
//				return false;
//			}
